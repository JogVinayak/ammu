...
while loggin in add textbox for entering server ip use it instead of local host since flutter application will be in android and server is hosted in lan in anoter machine 
